...
We started at <Price amount={26500} leading /> + utilities and in November 2023 we had our first adjustment. We're now settled at <Price amount={30750} />.
...
In my current apartment, water is included in my monthly rent. I also pay a fixed monthly
deposit of <Price amount={1500} leading /> for electricity.
Last but not least, there's a variable quarterly deposit for heating.
I've seen it ranging from <Price amount={2590} leading /> to <Price amount={4840} />.
...
In addition, I also have a 5G-based redundancy (unlimited data) for home internet
that costs <Price amount={900} />/month.
...
It costs me <Price amount={3650} leading /> for unlimited riding the entire network
...
In general, the public health system ([VZP](https://www.vzp.cz)) has your back if you're either
a Czech/EU citizen or if you're formally under an employment contract here, which is my case.

Unlike some other EU countries, spouses are not covered—which was a negative surprise.
My wife, for example, had to pay for a private system ([PVZP](https://www.pvzp.cz)) for a long time.
...
Many companies include this in the bonus package.
A monthly subscription in [Canadian Medical](https://www.canadian.cz/en/membership)
goes around <Price amount={2990} />.

### 🐶 Pets

For those into pet parenting, I'd it's quite ok too.

I spend around <Price amount={1300} leading /> on a 6kg dog food package every quarter.

We pay for a health plan that costs <Price amount={810} />/month.
The plan pays for itself soon enough, especially in cases of hospital admissions, expensive exams/sampling, etc.
...
About <Price amount={280} leading /> will get you lunch at a decent restaurant.
Dinner at a fancy place goes around <Price amount={450} leading /> - <Price amount={500} leading />
...
at the beginning of every month and then we buy other items on demand.
Much of this can be covered with a company meal voucher (usually at <Price amount={3000}/>/month).

At the end of the month, groceries usually go around <Price amount={8000} leading /> - <Price amount={9000} leading/>
for the two of us.

If you're wondering about prices for specific items, you might wanna check the English version
of [Rohlik.cz](https://www.rohlik.cz/en-CZ), a fine Czech online grocery store.

### 💰 Salary Ranges

I won't disclose my salary here but from what I've noticed in the local market, I'd say that
the average salary for a senior engineering position here
...
do not reflect the reality of most people here.
...
Taxes are based on how much you earn. There are [great tools](https://www.platy.cz/en/calculator)
out there to help you estimate your net salary.
