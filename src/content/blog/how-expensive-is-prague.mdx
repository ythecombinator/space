...
date: '2024-01-15'
tags: ['career', 'life']
summary: 'A perspective from a Latin expat.'
---

### Preamble

There's a recent trend amongst expat Brazilian developers in Twitter where they share their cost of living in their current cities.

I initially decided to follow the trend because:

- I think the type of content is super valid for those who want to live abroad. Especially those coming from quite different realities, like Latin America, Asia and Middle Eastern, and others.
...
- I myself wish I had something similar before I moved here and, even though I had planned my move here, I ended up being surprised by overall costs here and how much my purchasing power dropped for a while after moving.

Before we start, just a little bit of context:

1. I was born and raised in Fortaleza, Brazil. I already worked remotely abroad before coming here, living there.
1. I moved with my wife. Nowadays we have a chihuahua.
1. I am not an EU citizen and I work on a work permit here.
...
(originally written in `CZK`) also available in the following currencies: [USD](?currency=USD), [EUR](?currency=EUR), [GBP](?currency=GBP), [JPY](?currency=JPY) and [BRL](?currency=BRL).
...
Renting a flat in the center of Prague—as well as almost any European capital—will sound insanely expensive for anyone coming from prette much any city in Latin America and, in my opinion, one just can't compare the baseline here.
...
We decided to stay in this building/district. After the 30 days, we managed to move into a studio (~30m²) in the same building while we waited for a larger apartment to be vacant (the same as the one the company had picked up for me).
...
The pandemic came and we realized the two of us could us some more space in an apartment. That was also when Ricardo joined our family and we had to find another apartment because that one had internal rules against pets.
...
At the end of 2021, the owner of that apartment passed away and his family present us a leave notice.
...
<Admonition.Box>
  <Admonition.Title>This Day in History</Admonition.Title>
  <Admonition.Description>
...
Overall, the calc here is annual, based on average usage: if you used more, you pay the difference, if you used less, you get your money back.

### 🛜 Connectivity

I'd say that internet here is relatively cheap if compared to Brazil.
...
I did notice that neighborhoods within (or nearby) the historic center share the same issue with fiber internet coverage.
...
It costs me pay <Price amount={3650}/> for unlimited riding the entire network
(buses, cable cars, metro lines, boat, city trains, the funicular, etc.) within Prague for _a whole year_.

By the way, it also happens that some companies include an annual pass as part of their benefits package.

I myself have never checked the prices of bicycles, electric bikes and scooters, but
...
We lived our first few years here without it but nowadays this is really key to me. Many companies include this in the bonus package.
...
We pay for a health plan that costs <Price amount={810}/>/month. The plan is very worthwhile, especially in cases of hospital admissions, expensive exams/sampling, etc.
One-off vaccines cost in the range of <Price amount={800}/>-<Price amount={1200}/>.

A two hours visit to a fancy pet shop, with everything included, costs around <Price amount={1000}/>.
...
About <Price amount={280}/> will get you lunch at a really decent restaurant.
A dinner at a fancy place goes around <Price amount={450}/>/<Price amount={500}/>per person—and you'll eat really well!

### 🛒 Groceries

This is probably the most variable part of the equation because it takes countless factors into account.

My wife and I usually make a one-shot order in the range of <Price amount={4000}/> at the begingging of every month
...
At the end of the month, groceries usually go around <Price amount={8000}/> - <Price amount={9000}/>/month for the two of us.
...
People in tech positions are considered high skilled workers and these numbers do not reflect the reality of most people here.
...
Taxes are based on how much you earn. There are [great tools](https://www.platy.cz/en/calculator) out there to help you estimate your netto salary.

### Wrapping Up...

I'm not quite sure if I managed to cover everyone's questions around costs of living here, but
I'm always open to anyone who's got questions about career and life as an expat.

Last but not least, this is an ever-living posts and I'll keep updating it as I get more feedback and/or updates to share.
