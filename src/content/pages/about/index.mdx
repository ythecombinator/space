...
<Styled.RoleDescriptionContainer>
  ...
  <Styled.RoleDescriptionField>Jan 2021 – Present</Styled.RoleDescriptionField>
</Styled.RoleDescriptionContainer>

I address bugs and feature requests in the MicroApps Builder, a low-code tool part of Citrix Workspace Intelligence that allows developers to build event-driven and user-initiated microapps.
...
<p>These are the {data.length} countries where I've been to in this journey:</p>
