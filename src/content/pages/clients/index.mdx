...
import rebelGirls from "assets/clients/rebelgirls.png";
import bitcoinIRA from "assets/clients/bitcoin-ira.png";
import bredal from "assets/clients/bredal.png";
...
<CompanySlider
  data={[
    ...
    {
      name: "Rebel Girls",
      url: "https://www.rebelgirls.com",
      thumbnail: rebelGirls,
    },
    {
      name: "Bredal Australia",
      url: "https://www.bredalaustralia.com",
      thumbnail: bredal,
    },
    {
      name: "Bitcoin IRA",
      url: "https://bitcoinira.com",
      thumbnail: bitcoinIRA,
    },
...
I helped their Australian branch to design and build from scratch a management platform to validate different steps of their process, from when a purchase order is made to when the a is assembled.
