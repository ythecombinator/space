...
![Audience raising hands at React Day Berlin 2022](./audience-interactions.jpg)
...
![Tech Trivia at React Alicante](./trivia.jpg)
...
![Google Docs: Session details](./google-docs-talks.png)
...
![Google Docs: Personal details](./google-docs-bio.png)
...
![Notion: All sessions](./notion-list.png)

This also helps me organize their status on a calendar:

![Notion: Calendar](./notion-calendar.png)
...
![Notion: Info for each session](./notion-session.png)
...
![Me out there](./accomplishments.jpg)
...
![Medallia at React Alicante](./medallia+react-alicante.jpg)
